...
class MyUserAdmin(admin.ModelAdmin):
    list_display = ('username', 'email', 'short_code', 'public_uuid', 'is_subscription_free', 'trial_days', 'is_active', 'is_staff')
    readonly_fields = ('short_code', 'public_uuid', 'created_at', 'updated_at')
    search_fields = ('username', 'email', 'short_code', 'public_uuid')
    list_filter = ('is_subscription_free', 'is_active', 'is_staff')
