(function ($) {
  ...
  var Defaults = {
    ...
    dateCheckOut:new Date().setDate(new Date().getDate()+1),
    startDate: null,
    endDate: null,
    limitPrevMonth: 0, 
    limitNextMonth: 35,
    limitDateRanges: 1095,
  ...
  $.fn.tDatePicker = function (pr_el, options) {
    ...
    if (options !== undefined) {
      ...
      var num_Limit = update_options.limitDateRanges || 1095;
      var num_month_Limit = update_options.limitNextMonth || 35;
